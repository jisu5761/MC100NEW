...
#define SI446X_CSN			12
#define SI446X_SDN			14
#define SI446X_IRQ			35 // This needs to be an interrupt pin

#define SI446X_235CSN			12
#define SI446X_235SDN			14
#define SI446X_235IRQ			15 // This needs to be an interrupt pin


#define SI446X_358CSN			17
#define SI446X_358SDN			16
#define SI446X_358IRQ			19 // This needs to be an interrupt pin
