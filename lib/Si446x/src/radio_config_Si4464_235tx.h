...
#ifndef RADIO_CONFIG235TX_H_
#define RADIO_CONFIG235TX_H_
...
// RF Freq.(MHz): 235.3    API_TC: 29    fhst: 12500    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1    
// 
...
#define TX235RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ                     30000000L
#define TX235RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER                    0x00
#define TX235RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH               0x00
#define TX235RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP        0x03
#define TX235RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET       0xF000
...
*/
#define TX235RF_POWER_UP 0x02, 0x01, 0x00, 0x01, 0xC9, 0xC3, 0x80

/*
// Command:                  RF_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define TX235RF_GPIO_PIN_CFG 0x13, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define TX235RF_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x00, 0x52, 0x00
...
*/
#define TX235RF_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x60
...
*/
#define TX235RF_INT_CTL_ENABLE_1 0x11, 0x01, 0x01, 0x00, 0x00
...
*/
#define TX235RF_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define TX235RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x0A, 0x00, 0x07, 0x00, 0x4E, 0x20, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x00
...
*/
#define TX235RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x8C
...
*/
#define TX235RF_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0x00, 0x00, 0x70, 0x20
...
*/
#define TX235RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x01, 0xD5, 0x01, 0x17, 0x9F, 0x00, 0x8C, 0x00, 0xC2
...
*/
#define TX235RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x54, 0x36, 0x80, 0xAB, 0x02, 0x14, 0x80
...
*/
#define TX235RF_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0xE2
...
*/
#define TX235RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x67, 0x67, 0x00, 0x02, 0x40, 0x00, 0x00, 0x2A
...
*/
#define TX235RF_MODEM_OOK_CNT1_8 0x11, 0x20, 0x08, 0x42, 0x84, 0x03, 0xD6, 0x8F, 0x00, 0x44, 0x01, 0x80
...
*/
#define TX235RF_MODEM_RSSI_COMP_1 0x11, 0x20, 0x01, 0x4E, 0x40
...
*/
#define TX235RF_MODEM_CLKGEN_BAND_1 0x11, 0x20, 0x01, 0x51, 0x0C
...
*/
#define TX235RF_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11
...
*/
#define TX235RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1
...
*/
#define TX235RF_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00
...
*/
#define TX235RF_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x08, 0x18, 0x00, 0x3D
...
*/
#define TX235RF_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03
...
*/
#define TX235RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3D, 0x0D, 0xF0, 0xC3, 0x06, 0xD4, 0x20, 0xFC
...
#define TX235RADIO_CONFIGURATION_DATA_ARRAY { \
        0x07, TX235RF_POWER_UP, \
        0x08, TX235RF_GPIO_PIN_CFG, \
        0x06, TX235RF_GLOBAL_XO_TUNE_2, \
        0x05, TX235RF_GLOBAL_CONFIG_1, \
        0x05, TX235RF_INT_CTL_ENABLE_1, \
        0x08, TX235RF_FRR_CTL_A_MODE_4, \
        0x10, TX235RF_MODEM_MOD_TYPE_12, \
        0x05, TX235RF_MODEM_FREQ_DEV_0_1, \
        0x0C, TX235RF_MODEM_TX_RAMP_DELAY_8, \
        0x0D, TX235RF_MODEM_BCR_OSR_1_9, \
        0x0B, TX235RF_MODEM_AFC_GEAR_7, \
        0x05, TX235RF_MODEM_AGC_CONTROL_1, \
        0x0D, TX235RF_MODEM_AGC_WINDOW_SIZE_9, \
        0x0C, TX235RF_MODEM_OOK_CNT1_8, \
        0x05, TX235RF_MODEM_RSSI_COMP_1, \
        0x05, TX235RF_MODEM_CLKGEN_BAND_1, \
        0x10, TX235RF_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, TX235RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, TX235RF_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x08, TX235RF_PA_MODE_4, \
        0x0B, TX235RF_SYNTH_PFDCP_CPFF_7, \
        0x0C, TX235RF_FREQ_CONTROL_INTE_8, \
        0x00 \
 }
#else
#define TX235RADIO_CONFIGURATION_DATA_ARRAY { 0 }
#endif

// DEFAULT VALUES FOR CONFIGURATION PARAMETERS
#define TX235RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ_DEFAULT                     30000000L
#define TX235RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER_DEFAULT                    0x00
#define TX235RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH_DEFAULT               0x10
#define TX235RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP_DEFAULT        0x01
#define TX235RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET_DEFAULT       0x1000

#define TX235RADIO_CONFIGURATION_DATA_RADIO_PATCH_INCLUDED                      0x00
#define TX235RADIO_CONFIGURATION_DATA_RADIO_PATCH_SIZE                          0x00
#define TX235RADIO_CONFIGURATION_DATA_RADIO_PATCH                               {  }

#ifndef TX235RADIO_CONFIGURATION_DATA_ARRAY
#error "This property must be defined!"
#endif

#ifndef TX235RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ
#define TX235RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ          TX235RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ_DEFAULT 
#endif

#ifndef TX235RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER
#define TX235RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER         TX235RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER_DEFAULT 
#endif

#ifndef TX235RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH
#define TX235RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH    TX235RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH_DEFAULT 
#endif

#ifndef TX235RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP
#define TX235RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP   TX235RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP_DEFAULT 
#endif

#ifndef TX235RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET
#define TX235RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET  TX235RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET_DEFAULT 
#endif

#define TX235RADIO_CONFIGURATION_DATA { \
                            Radio_Configuration_Data_Array235Tx,                       \
                            TX235RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER,                   \
                            TX235RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH,              \
                            TX235RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP,       \
                            TX235RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET       \
                            }
